...
class Admin
{
    ...
    public function enqueueStyles(string $hook): void
    {
        ...
        $styleFileName = ($this->settings->getDebug() === true) ? 'ups-tracking-admin.css' : 'ups-tracking-admin.min.css';
    ...
    public function enqueueScripts(string $hook): void
    {
        ...
        $scripFileName = ($this->settings->getDebug() === true) ? 'ups-tracking-admin.js' : 'ups-tracking-admin.min.js';
